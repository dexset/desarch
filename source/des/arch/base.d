...
unittest
{
    ...
    assertEq( client.messages.length, 1 );
    assertEq( client.messages[0], "hello" );

    sigsig.number( 0 );

    assertEq( client.a, 3.15 );
    ...
    sigsig.number( 2 );
    assertEq( client.a, 5.15 );

    sigsig.comp.connect( c3.newSlot( &c3.cfunc ) );
    sigsig.comp( "okda", 13 );
    assertEq( c3.str, "okda" );
    assertEq( c3.num, 13 );
}
...
unittest
{
    ...
    assertEq( str_arr, ["hello","world"] );
    assertEq( int_arr, [3,5] );
}
