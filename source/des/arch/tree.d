...
unittest
{
    ...
    assertEq( a0.childs.length, 1 );
    assertEq( a1.childs.length, 1 );

    assertExcept!TNodeCycleException({ a2.attachChilds(a0); });
    assertExcept!TNodeNullChildException({ a2.attachChilds(null); });
}
